...
2. 确认窗口右上角显示当前版本，例如 **Version 0.9.5 (95)**。
...
8. 需要立即查看效果时，回到 App 点击 **Start Screen Saver**。App 会先把系统当前屏保切换到 Eagle Grid Saver，再启动屏保，避免误启动 macOS 原来选中的其他屏保。
...
2. Check the version in the top-right corner, such as **Version 0.9.5 (95)**.
