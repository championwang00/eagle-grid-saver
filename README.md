...
3. 确认窗口右上角显示当前版本，例如 **Version 0.9.10 (100)**。
...
2. 确认窗口右上角显示当前版本，例如 **Version 0.9.10 (100)**。
...
3. Check the version in the top-right corner, such as **Version 0.9.10 (100)**.
...
2. Check the version in the top-right corner, such as **Version 0.9.10 (100)**.
